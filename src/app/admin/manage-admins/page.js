...
import { FiAward, FiEye, FiMoreVertical, FiSearch, FiShield, FiTrash2, FiUserCheck, FiUsers, FiXCircle } from "react-icons/fi";
...
export default function ManageAdminsPage() {
  ...
  return (
    <div>
      ...
      <div className="mb-6 grid gap-4 md:grid-cols-3"><Metric icon={FiShield} label="Total Admins" value={admins.length} tone="red" /><Metric icon={FiAward} label="Super Admins" value="1" tone="blue" /><Metric icon={FiUserCheck} label="Active Admins" value={admins.filter((a) => a.status === "active").length} tone="green" /></div>
